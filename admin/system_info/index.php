		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">About Us</label>
	             <textarea name="about_us" id="about_us" cols="30" rows="2" class="form-control summernote"><?php echo  $_settings->info('ABOUT'); ?><?php  // echo  is_file(base_app.'about.html') ? file_get_contents(base_app.'about.html') : "" ?></textarea>
			</div>
			<div class="form-group">
